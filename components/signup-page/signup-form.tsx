...
const SignupForm = () => {
  ...
  return (
    <div className="text-text bg-white/10 backdrop-blur-sm w-full h-full rounded-3xl p-8 flex flex-col justify-between space-y-16">
      <form
      ...
      >
        ...
        <div className="w-full text-right">
          <Button
            ...
            styles=" disabled:opacity-50 disabled:hover:bg-secondary bg-secondary hover:bg-secondary/50 w-full h-12"
          >
